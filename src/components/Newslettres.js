...
<form class="input-group mb-3 col-md-12 col-sm-10">
  <input type="text" class="text text-1 form-control" placeholder="Saisir email" aria-label="Saisir email" aria-describedby="basic-addon2"/>
