  ...
  const renderContent = () => {
    if (!flipped) {
      ...
      contre Elise Mertens
       ...
       quarts de finale</p>
       <p className="description">La Tunisienne Ons Jabeur s'est qualifiée pour les
      ...
      <p className='title2'><span>Club africain:</span> 
       ...
       <p className="description2">Le président du Club Africain, Youssef El Almi, a indiqué, dans une déclaration accordée à Mosaïque FM, que Adel Sellimi exerce toujours ses fonctions à la tête de la barre technique de l’équipe séniors et que le comité directeur n’a pris aucune décision à son sujet.
